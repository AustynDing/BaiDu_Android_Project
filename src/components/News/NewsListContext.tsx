...
export function NewsListProvider({ children }: { children: any }) {
    ...
    const addNewsInList = React.useCallback((news: NewsType) => {
...
export const useFetchNewsList = () => React.useContext(NewsListContext).fetchNewsList
export const useNewsList = () => React.useContext(NewsListContext).newsList
export const useAddNewsInList = () => React.useContext(NewsListContext).addNewsInList
/**
