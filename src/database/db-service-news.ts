...
export const getDBConnection = (() => {
  ...
  return async () => {
    if (!dbConnection) {
      dbConnection = await openDatabase({ name: 'androidDemo.db', location: 'default' })
    }
    return dbConnection
  }
})()
